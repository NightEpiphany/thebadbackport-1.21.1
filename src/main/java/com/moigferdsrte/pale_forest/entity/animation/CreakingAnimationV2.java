...
public class CreakingAnimationV2 {

    public static final Animation CREAKING_WALK = Animation.Builder.create(1.125F)
            .looping()
            .addBoneAnimation(
                    "upper_body",
                    new Transformation(
            ...
            .build();
    public static final Animation CREAKING_ATTACK = Animation.Builder.create(0.7083F)
            .looping()
            .addBoneAnimation(
                    "upper_body",
                    new Transformation(
            ...
            .build();
    public static final Animation CREAKING_INVULNERABLE = Animation.Builder.create(0.2917F)
            .addBoneAnimation(
                    "upper_body",
                    new Transformation(
                            Transformation.Targets.ROTATE,
            ...
            .build();
    public static final Animation CREAKING_DEATH = Animation.Builder.create(2.25F)
            .addBoneAnimation(
                    "upper_body",
                    new Transformation(
                            Transformation.Targets.ROTATE,
