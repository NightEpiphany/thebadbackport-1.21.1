...
public class BlueEggEntity extends ThrownItemEntity {

    private static final EntityDimensions EMPTY_DIMENSIONS = EntityDimensions.fixed(0.0F, 0.0F);

    public BlueEggEntity(EntityType<? extends ThrownItemEntity> entityType, World world) {
        super(entityType, world);
    }

    public BlueEggEntity(World world, LivingEntity owner) {
        super(ModEntities.BLUE_EGG, owner, world);
    }

    public BlueEggEntity(World world, double x, double y, double z) {
        super(ModEntities.BLUE_EGG, x, y, z, world);
    }
