...
public class RunCopperGolemStatueBlockEntity extends BlockEntity {
    public RunCopperGolemStatueBlockEntity(BlockPos pos, BlockState state) {
        super(ModBlockEntities.RUN_COPPER_GOLEM_STATUE, pos, state);
    }
