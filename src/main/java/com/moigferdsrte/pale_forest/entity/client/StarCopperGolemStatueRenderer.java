...
public class StarCopperGolemStatueRenderer implements BlockEntityRenderer<StarCopperGolemStatueBlockEntity> {

    public static final EntityModelLayer LAYER = new EntityModelLayer(Identifier.of(ThePaleForest.MOD_ID, "copper_golem_star"), "main");

    private final ModelPart golem;

    @Environment(EnvType.CLIENT)
    public StarCopperGolemStatueRenderer(BlockEntityRendererFactory.Context context) {
    ...
    public static TexturedModelData getTexturedModelData() {
        ...
        arms.addChild("right_r1", ModelPartBuilder.create().uv(50, 16).cuboid(-1.0F, -2.0F, -3.0F, 3.0F, 10.0F, 4.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, 1.0F, -1.0F, 0.0F, 0.0F, -2.1817F));

        arms.addChild("left_r1", ModelPartBuilder.create().uv(36, 16).cuboid(-2.0F, -2.0F, -3.0F, 3.0F, 10.0F, 4.0F, new Dilation(0.0F)), ModelTransform.of(-6.0F, 1.0F, -1.0F, 0.0F, 0.0F, 2.1817F));
        ...
        legs.addChild("left_r2", ModelPartBuilder.create().uv(16, 27).cuboid(-3.0F, -2.0F, -3.0F, 4.0F, 5.0F, 4.0F, new Dilation(0.0F)), ModelTransform.of(4.0F, -4.0F, 1.0F, 0.0F, 0.0F, -0.3927F));

        legs.addChild("right_r2", ModelPartBuilder.create().uv(0, 27).cuboid(-3.0F, -2.0F, -3.0F, 4.0F, 5.0F, 4.0F, new Dilation(0.0F)), ModelTransform.of(-2.0F, -3.0F, 1.0F, 0.0F, 0.0F, 0.3054F));
        return TexturedModelData.of(modelData, 64, 64);
    }

    @Override
    public void render(
            StarCopperGolemStatueBlockEntity entity,
            float tickDelta,
